        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <table border="1" style="margin: 0; width: 100%;" class="table">
                                <tr>
                                    <td>Tên sản phẩm</td>
                                    <td>ma loai</td>
                                ...
                                <?php foreach ($products as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><img width="200px" src="../public/layout/img/product/<?php echo $value->hinh ?>" alt=""></td>
                                        <td><?php echo $value->giam_gia ?> %</td>
                                        <td style="width: 150px; padding-right: 20px;">
                                            <a style="padding: 0 5px;" class="act" href="delete_prd.php?id=<?php echo $value->id ?>">Xóa</a>
                                            <a class="act" href="edit_prd.php?id=<?php echo $value->id ?>">Sửa</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </table>
