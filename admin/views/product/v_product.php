<div id="main-wrapper">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="v_product.php" aria-expanded="false"><span class="hide-menu">Products</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="charts.html" aria-expanded="false"><span class="hide-menu">Products</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="widgets.html" aria-expanded="false"></i><span class="hide-menu">User</span></a></li>
        ...
        <table border="1" class="table">
            ...
            <tr>
                ...
                <td><img width="200px" src="public/assets/product/<?php echo $value->hinh ?>" alt=""></td>
                <td><?php echo $value -> giam_gia ?> %</td>
                <td><a onclick="return(confirm('Bạn có chắc chắn muốn xóa')" href="delete_prd.php?id=<?php echo $value-> id?>">Xóa</a> <button>sửa</button></td>
            </tr>
            <?php }?>
        </table>
        </div>
