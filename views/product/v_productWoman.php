                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-9 col-lg-8">
                            ...
                            <div class="row">
                                <?php foreach($prdWoman as $key => $value){ ?>
                                <div class="col-xl-4 col-sm-6">
                                    <div class="new-arrival-item text-center mb-50">
                                        <div class="thumb mb-25">
                                        <div class="discount-tag" style="margin-left: 20px;">- <?php echo $value -> giam_gia ?>%</div>
                                            <a href="detail.php?id=<?php echo $value->id ?>"><img style="width: 250px; height: 280px;" src="public/layout/img/product/<?php echo $value->hinh ?>" alt=""></a>
