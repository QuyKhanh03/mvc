                            ...
                            <div class="col">
                                <div class="features-product-item mb-30">
                                    <div class="features-product-thumb">
                                        <div class="discount-tag">-<?php echo $value->giam_gia ?>%</div>
                                        <a href="detail.php?id=<?= $value->id ?>">
                                            <img width="210px" height="190px" src="public/layout/img/product/<?php echo $value->hinh   ?>" alt="">
                                        </a>
                                        <div class="product-overlay-action">
                                            <ul>
                                                <li><a href="cart.html"><i class="far fa-heart"></i></a></li>
                                                <li><a href="detail.php?id=<?= $value->id ?>"><i class="far fa-eye"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="features-product-content">
                                        ...
                                        <h5><a href="detail.php?id=<?= $value->id ?>"><?php echo $value->ten_san_pham ?></a></h5>
                                        <p class="price">$<?php echo $value->don_gia ?>.00</p>
