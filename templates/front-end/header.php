                                ...
                                <li class="sign-in">
                                    <a href="lognIn.php">
                                        ...
                                        if (isset($_SESSION["user"])) {
                                            // echo $_SESSION["user"]["ten_nguoi_dung"];
                                            // header("location:index.php");
                                            echo '<a class="out" name="func" href="logout.php?func=exit"><i class="fa-solid fa-right-from-bracket"></i></a>';
                                        } else {
                                            echo "Sign In ";
                                            ...
                                            <ul class="cat-mega-menu">
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li class="cat-mega-menu-banner"><a href="#"><img src="public/layout/img/images/megamenu_banner.jpg" alt=""></a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </li>
